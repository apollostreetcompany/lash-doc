...
```
TASK
Doc Chat: AI responses with citations:
- AI answers must include citations to doc ranges or specific versions.
- Clicking a citation jumps to that slice or opens a side-by-side context.

CONSTRAINTS
- No freeform text without citations for doc-derived claims.
- Deterministic citation formatting in tests.

DELIVERABLES
- Citation rendering + jump handlers; test provider for AI.
- Tests:
  - I.4 `ai-chat-citation`, `ai-citation-jump`

ACCEPTANCE
- Both tests green; citations reliably open referenced context.
```
