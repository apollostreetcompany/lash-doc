/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.jsonc src/worker-configuration.d.ts` (hash: e42bd1b08330315dbf73fc85687cb445)
// Runtime types generated with workerd@1.20260601.1 2026-06-03 nodejs_compat
interface __BaseEnv_Env {
	LASH_REALTIME_ROOM: DurableObjectNamespace<import("./index").LashRealtimeRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "LashRealtimeRoom";
	}
