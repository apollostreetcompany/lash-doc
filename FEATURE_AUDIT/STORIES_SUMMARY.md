...
| COM-01      | passed with anchor-model caveat | `artifacts/ux-sprint/reports/com-01-visual-proof.md`; `artifacts/ux-sprint/reports/com-01-e2e.log` |
...
- COM-01: comments/chat now expose a document-side marker, compact target row, and Show-in-document action; duplicate identical text can still map to the first matching occurrence until a later anchor-model bead stores true editor positions.
