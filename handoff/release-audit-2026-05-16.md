...
- Default branch: `main`.
- PR #1: `https://github.com/apollostreetcompany/lash-doc/pull/1`, merged at `2026-05-16T06:25:59Z`.
- Main merge commit: `7bf032debe1931d068f009ee735b95bd5c43b5c1`.
- Main CI: run `25955018685`, workflow `CI`, event `push`, branch `main`, conclusion `success`.
...
- `pnpm run build` - pass.
- Main GitHub Actions `build-and-test` - pass on `7bf032debe1931d068f009ee735b95bd5c43b5c1`.
...
| All beads through completion                                | `handoff/beads.jsonl` records beads 0-20; PR #1 is merged; Bead 20 records final audit cleanup.              |
...
| GitHub remote and protected release flow                    | Remote exists, `main` is default, branch protection requires `build-and-test`, PR #1 merged.                 |
...
The current Lash v1 objective is satisfied once Bead 20 is merged and its CI passes: the full local product gates are covered, tested, merged through a protected branch flow, and auditable. Remaining work is post-v1 scope.
